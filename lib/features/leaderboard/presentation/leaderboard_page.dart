      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            const Text(
              'Total KM earned through attendance.',
            ...
            leaderboard.when(
              ...
              data: (entries) {
                if (entries.isEmpty) {
                  return const Text('No runners yet.',
                      ...
                      Row(
                        ...
                        children: [
                          if (top3.length > 1)
                            Expanded(
                                child:
                                    _PodiumBlock(entry: top3[1], height: 160)),
                          Expanded(
                              child: _PodiumBlock(entry: top3[0], height: 200)),
                          if (top3.length > 2)
                            Expanded(
                                child:
                                    _PodiumBlock(entry: top3[2], height: 130)),
                        ],
                      )
                    else
                      Column(
                          children: top3
                              .map((e) => _PodiumBlock(entry: e, height: 100))
                              .toList()),
                    const SizedBox(height: 48),
                    const RzStarDivider(),
